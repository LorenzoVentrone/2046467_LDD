...
Actuator · POST /api/actuators/habitat_heaterPart 2: Automation & Rule Management (10 Stories)
US-11 — Rule Builder Interface (UI) As a system administrator, I want a d Ashboard form to create new automation rules using the format IF <sensor_name> <operator> <value> THEN set <actuator_name> to ON/OFF  so the system can manage devices automatically.
Rule Engine UI
